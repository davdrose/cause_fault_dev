...
Responsibility requires causation. But there are different kinds of causes. Some causes are connected to their effects and produce them directly or indirectly. Others are disconnected from their effects, involve absences, and thus don't produce them. We ask how children's developing ability to distinguish these relates to their understanding of moral responsibility. We found in Experiment 1 that when Andy hits Suzy with his bike, she falls into a fence and it breaks, 3-year-old children treated "caused", "break" and "fault" as referring to the direct cause, Suzy. By 4, they differentiated causes: Andy "caused" the fence to break, it's his "fault", but Suzy "broke" it. We found in Experiment 2 that when Suzy lets go of a rope, Andy falls into a fan and it breaks, 3-year-olds treated "caused", "break" and "fault" as referring to the direct cause, Andy. Around 5 they distinguished causes, saying that the disconnecting cause, Suzy--who is related to the effect by an absence--"caused" the fan to break and is at "fault", but Andy "broke" it.  Our findings relate to the outcome-to-intention shift in moral responsibility and suggest a more fundamental shift in children's understanding of causation. 
